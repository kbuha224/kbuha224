<?php
    ...
    // $checkme = isset($_POST['rememberme'])?true:false;
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="container">
        <form action="validateuser.php" method="POST" enctype="multipart/form-data" class="offset-2">
            <div class="row  mb-3">
                ...
                <div class="col-lg-6">
                    <input class="form-control" value="<?= $user ?>" type="email" name="username"/>
            	</div>
            </div>
            <div class="row mb-3">
                <div class="col-lg-3">
                ...
                <div class="col-lg-6">
                    <input class="form-control" value="<?= $pass ?>" type="password" name="password"/>
                </div>
            </div>
